...
class Command(BaseCommand):
    ...
    def handle_message(self, msg: Message) -> None:
        ...
        if not tg_user.is_verified:
            ...
            self.tg_client.send_message(msg.msg_from.id, text=tg_user.verification_code)
        else:
            ...
            match msg.text:
                case '/goals':
                    ...
                    if goals_str:
                        ...
                        self.tg_client.send_message(msg.msg_from.id, 'No goals found')
                case _:
                    self.tg_client.send_message(msg.msg_from.id, 'Unknown command')
